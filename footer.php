				...
				<div class="pad group">
					...
					<div class="grid one-full">
						...
						<div id="copyright">
							...
							<?php else: ?>
								<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'cardstyle' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'cardstyle' ); ?></p>
							<?php endif; ?>
						</div><!--/#copyright-->
						
						<?php if ( get_theme_mod( 'credit', 'on' ) == 'on' ): ?>
						<div id="credit">
							<p><?php esc_html_e('Powered by','cardstyle'); ?> <a href="<?php esc_url( _e( 'https://wordpress.org', 'cardstyle' ) ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','cardstyle'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
						
						<?php if ( get_theme_mod( 'footer-social', 'on' ) == 'on' ): ?>
							<?php cardstyle_social_links() ; ?>
						<?php endif; ?>
